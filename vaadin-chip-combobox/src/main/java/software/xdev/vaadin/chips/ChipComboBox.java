	...
	HasSize
{
	...
	protected final Button btnReset = new Button(VaadinIcon.TRASH.create());
	...
	protected void updateSelectedChips()
	{
		...
		// PoC: Maybe the reset button could be at the end of the chips?
		// this.chipsContainer.add(this.btnReset);
	}
